...
const counterHours = setInterval(function() {
    ...
    const targetDayEvent = Math.floor(targetToEvent / 86400000);
    const targetHoursEvent = String(Math.floor(targetToEvent % 86400000 / 3600000)).padStart(2, "0");
    const targetMinutesEvent = String(Math.floor(targetToEvent % 3600000 / 60000)).padStart(2, "0");
    const targetSecondsEvent = String(Math.floor(targetToEvent % 60000 / 1000)).padStart(2, "0");
    ...
    document.getElementById('counter').innerHTML = "come\xe7a em " + `${counterDown}`;
    if (targetToEvent < 0) {
...
//# sourceMappingURL=CODE.900caf0b.js.map
